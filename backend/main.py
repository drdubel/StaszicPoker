...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://staszicpoker-1.onrender.com"],
...
async def auth(request: Request):
    ...
    if user:
        ...
        response = RedirectResponse(url="http://staszicpoker-1.onrender.com/lobby")
...
async def logout(request: Request, response: Response, access_token: Optional[str] = Cookie(None)):
    ...
    return RedirectResponse(url="http://staszicpoker-1.onrender.com/")
